...
Platform metrics are metrics that are exposed by Sysdig-enabled services and the platform in {{site.data.keyword.cloud_notm}}. You must configure a Sysdig instance in a region to monitor these metrics.
{:shortdesc}
