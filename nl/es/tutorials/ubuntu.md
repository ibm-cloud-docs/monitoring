...
1. Abra un terminal. A continuación, inicie una sesión en {{site.data.keyword.cloud_notm}}. Ejecute el mandato siguiente y siga las indicaciones:
    ...
    Seleccione la cuenta en la que está disponible la instancia de {{site.data.keyword.mon_full_notm}}.
...
En la sección *Host y contenedores*, encontrará la entrada correspondiente al servidor Ubuntu. Pulse **Host y contenedores**![Host y contenedores](../images/switch_hosts.png) para cambiar los orígenes de datos. A continuación, seleccione el servidor Ubuntu. Los datos que se muestran corresponden al servidor Ubuntu que seleccione.
