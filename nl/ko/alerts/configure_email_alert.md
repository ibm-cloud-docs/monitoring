...
# {{site.data.keyword.monitoringshort}} API를 사용하여 이메일 경보 구성
{: #configure_email_alert}

메트릭에 대한 이메일 경보를 구성하려면 규칙과 이메일 알림을 정의하십시오. 그런 다음, 규칙과 알림 방법을 {{site.data.keyword.monitoringshort}} 서비스에 등록하십시오.
{:shortdesc}
...
이메일을 보내는 알림 파일을 작성하려면 다음 정보를 고려하십시오.

* 이메일을 발송하기 위한 알림 템플리트를 사용하십시오. 자세한 정보는 [알림 템플리트](/docs/services/cloud-monitoring?topic=cloud-monitoring-config_alerts_ov#notification_template)를 참조하십시오.
* 로컬 디렉토리에 파일을 작성하십시오(예: `~/cloud-monitoring/notifications`).

예를 들어, vi 편집기를 사용하여 **email.json** 파일을 작성하십시오. 
