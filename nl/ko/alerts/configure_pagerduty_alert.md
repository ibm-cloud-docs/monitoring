...
# {{site.data.keyword.monitoringshort}} API를 사용하여 PagerDuty 경보 구성
{: #configure_pagerduty_alert}

메트릭에 대한 PagerDuty 경보를 구성하려면 규칙과 PagerDuty 알림을 정의하십시오. 그런 다음, 규칙과 알림 방법을 {{site.data.keyword.monitoringshort}} 서비스에 등록하십시오.
{:shortdesc}
