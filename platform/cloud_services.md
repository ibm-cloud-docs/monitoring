...
{: caption="List of classic infrastructure services (generation 1)" caption-side="top"}
...
{: caption="Satellite" caption-side="top"}
...
{: caption="VMware as a Service" caption-side="top"}
