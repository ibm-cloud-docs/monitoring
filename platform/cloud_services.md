...
| [{{site.data.keyword.databases-for-mysql_full_notm}}](/docs/databases-for-mysql) | {{site.data.keyword.databases-for-mysql_full_notm}} is a managed MySQL service that is hosted in the {{site.data.keyword.cloud_notm}} and integrated with other {{site.data.keyword.cloud_notm}} services.  | [Platform metrics](/docs/databases-for-mysql?topic=databases-for-mysql-monitoring) |
