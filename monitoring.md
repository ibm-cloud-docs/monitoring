...
* [Default metrics](/docs/services/Monitoring-with-Sysdig/metrics.html#metrics_default) 
* [Custom metrics](/docs/services/Monitoring-with-Sysdig/metrics.html#metrics_custom)
...
For more information, see [Labels](/docs/services/Monitoring-with-Sysdig/metrics.html#metrics_labels).
...
| Task | Description |
|------|-------------|
| [Copy panel](/docs/services/Monitoring-with-Sysdig/panel.html#panels_copy) | Copy a panel into a new dashboard.  |
| [Change scope](/docs/services/Monitoring-with-Sysdig/panel.html#panels_change) | Change the scope of a panel. |
| [Duplicate panel](/docs/services/Monitoring-with-Sysdig/panel.html#panels_duplicate) | Copy a panel in the same dashboard.  |
| [Delete panel](/docs/services/Monitoring-with-Sysdig/panel.html#panels_delete) | Delete a panel from the dashboard.  |
| [Export data](/docs/services/Monitoring-with-Sysdig/panel.html#panels_export) | Export data from a panel into a csv file or a json file.  |
| [Create alert](/docs/services/Monitoring-with-Sysdig/panel.html#panels_alert) | Define an alert on a metric. |
...
| Task | Description |
|------|-------------|
| [Create dashboard](/docs/services/Monitoring-with-Sysdig/dashboards.html#dashboards_create) | Create a custom dashboard in the web UI. |
| [Copy a dashboard](/docs/services/Monitoring-with-Sysdig/dashboards.html#dashboards_copy) | Make a copy of a dashboard in the current team where the dashboard is available, or copy a dashboard to another team. |
| [Changing the scope](/docs/services/Monitoring-with-Sysdig/dashboards.html#dashboards_scope) | Chang the scope of a dashboard.       |
| [Delete dashboard](/docs/services/Monitoring-with-Sysdig/dashboards.html#dashboards_delete) |  Delete a dashboard. |
...
| Task                    |	Using REST API                |
|-------------------------|-------------------------------|
| Create a dashboard      | [Creating a dashboard by using the API](/docs/services/Monitoring-with-Sysdig/api.html#api_create_dashboard) |
| Delete a dashboard      | [Deleting a dashboard by using the API](/docs/services/Monitoring-with-Sysdig/api.html#api_delete_dashboard) |
| Saving dashboards       | [Saving the dashboards of a team by using the API](/docs/services/Monitoring-with-Sysdig/api.html#api_save_dashboard) |
...
* *Alert events* are events that are triggered by user-configured alerts. For more information, see [Working with alerts](/docs/services/Monitoring-with-Sysdig/monitoring.html#monitoring_alerts).
...
For more information, see [Configuring a notification channel](/docs/services/Monitoring-with-Sysdig/notifications.html#notifications_create).
...
* [Creating a capture](/docs/services/Monitoring-with-Sysdig/captures.html#captures_create)
* [Deleting a capture](/docs/services/Monitoring-with-Sysdig/captures.html#captures_delete)
* [Explore a capture](/docs/services/Monitoring-with-Sysdig/captures.html#captures_explore)
* [Download a capture](/docs/services/Monitoring-with-Sysdig/captures.html#captures_download)
