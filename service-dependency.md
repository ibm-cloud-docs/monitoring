...
|:---|:---|:---|:---|:---|
| IBM Cloud Internet Services | Change management, Disaster recovery, Instance control, Security compliance | No | Both |  us-south  |
...
| IBM Cloud Service Endpoints | Change management, Disaster recovery, Instance control | No | Both |  Same region  |
| IBM Key Protect for IBM Cloud | Change management, Disaster recovery, Instance control, Security compliance | No | Both |  Same region  |
| IBM Cloud Activity Tracker event routing | Availability, Operations, Security compliance | No | Both |  Same region  |
| IBM Cloud Databases - databases-for-postgresql | Change management, Disaster recovery, Instance control | No | Both |  Same region  |
| IBM Cloud Global Resource Catalog | Change management, Instance control | No | Both |  Same region  |
| IBM Cloud Classic DNS Servers | Change management, Instance control | No | Both |  Same data center  |
| IBM Cloud Classic Infrastructure Resource Management | Change management, Instance control | No | Both |  Same region  |
| IBM Cloud Databases - databases-for-mongodb | Change management, Disaster recovery, Instance control | No | Both |  Same region  |
| IBM Cloud Databases - databases-for-redis | Change management, Disaster recovery, Instance control | No | Both |  Same region  |
| IBM Cloud Kubernetes Service and Red Hat OpenShift on IBM Cloud - containers-kubernetes | Change management, Disaster recovery, Instance control, Security compliance | No | Both |  Same region  |
| IBM Cloud Object Storage | Change management, Disaster recovery, Instance control, Security compliance | No | Both |  Same region  |
| IBM Cloud Business Support Services | Change management, Instance control | No | Both |  Same region  |
...
{: row-headers}
{: caption="IBM Cloud Monitoring service dependency information - Significant dependencies" caption-side="top"}
{: tab-title="Significant dependencies"}
{: tab-group="service-dependency-data-for-sysdig-monitor"}
